(define (problem Tetris-8-4-1213405)
(:domain Tetris)
(:objects  
...
(at_two straight0 f6-3f f6-2f)
(at_two straight1 f3-1f f4-1f)
(at_two straight2 f3-3f f3-2f)
(at_square square0 f0-1f)
(at_square square1 f4-3f)
(at_square square2 f5-2f)
)
(:goal
(and
(clear f0-0f)
