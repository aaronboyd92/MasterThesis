(define (problem strips-mysty-x-15)
   ...
   (:objects turkey lamb pea cod chicken cantelope broccoli lemon
	pistachio lobster pepper bacon ham haroset okra cucumber onion - food 
        curiosity expectation understanding learning satisfaction
        stimulation entertainment satiety lubricity aesthetics empathy - pleasure
        anxiety boils anger angina prostatitis laceration depression
        jealousy loneliness hangover grief sciatica dread - pain 
	oregon goias surrey moravia bavaria alsace arizona manitoba bosnia
        pennsylvania quebec - province
