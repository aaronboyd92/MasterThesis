(define (problem strips-mysty-x-20)
   ...
   (:objects mutton cod muffin tuna pork sweetroll yogurt
	...
	love curiosity aesthetics empathy
        satisfaction triumph intoxication lubricity expectation
        understanding achievement - pleasure
	dread abrasion grief laceration - pain 
	manitoba guanabara quebec alsace kentucky moravia bosnia goias arizona
        oregon surrey bavaria - province
