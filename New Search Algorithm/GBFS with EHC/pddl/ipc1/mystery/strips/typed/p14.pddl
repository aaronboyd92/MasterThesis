(define (problem strips-mysty-x-14)
   ...
   (:objects pea chocolate lobster potato hotdog baguette wurst
	...
	laceration hangover grief sciatica dread loneliness
        ...
        dread-22 grief-19 angina-20 abrasion-21 - pain 
	alsace arizona pennsylvania surrey quebec bavaria - province
