...
typesList.add(new Symbol(Symbol.Kind.TYPE, token));
    ...
    } else if (jj_2_15(2) && ((this.isRequirement(RequireKey.TYPING) && this.isRequirement(RequireKey.OBJECT_FLUENTS))
                                        || this.isRequirement(RequireKey.FLUENTS))) {
      typesList = type();
{if ("" != null) return typesList;}
    } else {
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp node() throws ParseException {Exp node = null;
    if (jj_2_29(2)) {
      ...
      node = and_gd();
    } else if (jj_2_31(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS))) {
      node = or_gd();
    } else if (jj_2_32(2) && (this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = not_gd();
      ...
      node = imply_gd();
    } else if (jj_2_34(2) && (this.isRequirement(RequireKey.EXISTENTIAL_PRECONDITIONS))) {
      node = exists_gd();
    } else if (jj_2_35(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_gd();
...
this.domain.addOperator(op);
    } else if (jj_2_59(2) && (this.isRequirement(RequireKey.DURATIVE_ACTIONS))) {
      op = durative_action_def();
this.domain.addOperator(op);
    } else if (jj_2_60(2) && (this.isRequirement(RequireKey.DERIVED_PREDICATES))) {
      dp = derived_def();
...
{if ("" != null) return new Symbol(Symbol.Kind.ACTION, t);}
  ...
  final public Exp pre_gd() throws ParseException {Exp node = null;
    if (jj_2_61(3) && (this.isRequirement(RequireKey.PREFERENCES))) {
      ...
      node = and_pre_gd();
    } else if (jj_2_63(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pre_gd();
    } else if (jj_2_64(2)) {
      node = empty_or();
    } else if (jj_2_65(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp c_effect() throws ParseException {Exp node = null;
    if (jj_2_70(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_71(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
...
{if ("" != null) return new Symbol(Symbol.Kind.ACTION, t);}
  ...
  final public Exp duration_constraint() throws ParseException {Exp node = null;
    if (jj_2_85(2)) {
      node = empty_or();
    } else if (jj_2_86(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
...
node.addChild(child);
  ...
  final public Exp d_op() throws ParseException {Exp node = null;
    if (jj_2_93(2)) {
      node = equal_d_op();
    } else if (jj_2_94(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
    } else if (jj_2_95(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = lequal_d_op();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp da_gd() throws ParseException {Exp node = null;
    if (jj_2_98(2)) {
      ...
      node = and_da_gd();
    } else if (jj_2_100(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
node.addChild(child);
  ...
  final public Exp da_effect() throws ParseException {Exp node = null;
    if (jj_2_108(2)) {
      ...
      node = timed_effect();
    } else if (jj_2_110(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_da_effect();
    } else if (jj_2_111(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = when_da_effect();
...
{if ("" != null) return node;}
  ...
  final public Exp timed_effect() throws ParseException {Exp node = null;
    if (jj_2_129(2)) {
      node = at_a_effect();
    } else if (jj_2_130(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp f_exp_da() throws ParseException {Exp node = null;
    if (jj_2_149(2)) {
      node = da_op();
    } else if (jj_2_150(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = var_duration();
    } else if (jj_2_151(2)) {
      node = f_exp();
    } else {
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp init_el() throws ParseException {Exp node = null;
    if (jj_2_171(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_172(2)) {
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp pref_con_gd() throws ParseException {Exp node = null;
    ...
    } else if (jj_2_175(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
...
{if ("" != null) return node;}
  ...
  private boolean jj_3R_102()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.DURATION_INEQUALITIES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_95()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_62()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_37()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_33()
 {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_60()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_111()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_103()) return true;
    }
    return false;
  }
  ...
  private boolean jj_3R_114()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_100()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_152()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_173()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_65()
 {
  ...
  static {
   ...
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x3c000000,0x0,0x0,0x0,0x3c000000,0x3c000000,0x3c000000,0x20,0x3c000000,0x3c000000,0x3c000000,0x0,0x3c000000,0x0,0x0,0x0,0x0,0x80000000,};
   }
