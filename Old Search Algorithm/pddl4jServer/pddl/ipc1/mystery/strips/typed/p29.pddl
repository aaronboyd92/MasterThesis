(define (problem strips-mysty-x-29)
   ...
   (:objects papaya scallop melon popover pear shrimp broccoli pork - food
    	achievement excitement - pleasure
	abrasion hangover anger laceration anxiety
        angina grief prostatitis boils sciatica jealousy - pain 
