(define (problem strips-mysty-x-6)
   ...
   (:objects tomato rice popover cantelope tuna papaya chicken
	...
	love intoxication rest aesthetics achievement excitement satisfaction curiosity
        lubricity understanding triumph - pleasure 
	anger hangover sciatica grief abrasion prostatitis angina boils loneliness - pain 
	bosnia surrey kentucky alsace goias quebec arizona - province
